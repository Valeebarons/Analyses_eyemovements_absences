...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %
  % Imports position of extracted dipole fit position for the two groups from dipfitFT_allpat.m. 
  % determine if dipoles for each patient and groups are positioned within
  % the FEF from Vernet et al. 2014
  % plots 5 FEF and determines dipoled positioned in left, right and bilateral FEF 
  %  
  % needs tal2mni.m
  % needs spm_matrix.m
